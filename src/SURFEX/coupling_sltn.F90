...
!
WRITE(*,*) 'XPI=', XPI
WRITE(*,*) 'XAVOGADRO=', XAVOGADRO
WRITE(*,*) 'XDENSITY_SLT=', XDENSITY_SLT
WRITE(*,*) 'ZCONVERTFACM3_SLT=', ZCONVERTFACM3_SLT
!
PSFSLT(:,:)=0.d0
!
!+ Marine
...
! flux de moments se fait plus tard (mode_dslt_surf.F90 MASSFLUX2MOMENTFLUX)
  ...
  ELSE ! cas 2 moments
    ...
    WRITE(*,*) 'JORIS, ZSFSLT_MDE(:,JORDER_SLT(JN))=' , ZSFSLT_MDE(:,JORDER_SLT(JN))
    WRITE(*,*) 'JORIS, SLT%XEMISRADIUS_SLT(JN)=' , SLT%XEMISRADIUS_SLT(JN)
    WRITE(*,*) 'JORIS, SLT%XEMISSIG_SLT(JN)=' , SLT%XEMISSIG_SLT(JN)
    WRITE(*,*) 'JORIS, ZCONVERTFACM3_SLT=' , ZCONVERTFACM3_SLT
...
WRITE(11,*) ZREYNOLDS, (ZSFSLT_MDE(1,JN),JN=1,JPMODE_SLT)
WRITE(12,*) ZREYNOLDS, (PSFSLT(1,JN),JN=1,KSLT)
